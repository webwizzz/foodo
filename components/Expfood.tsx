    ...
    >
      <div className="pl-6 sm:pl-10 md:pl-16 lg:pl-40 max-w-3xl">
        ...
        <motion.h2
          ...
          className="text-balance font-sans font-semibold text-4xl md:text-5xl lg:text-6xl tracking-tight"
        >
          Experience Food
        </motion.h2>
        ...
        <div className="mt-8">
          {textPhrases.map((phrase, index) => (
            <motion.p
              ...
              className="text-pretty font-sans text-zinc-300 text-lg md:text-xl leading-tight"
            >
              {phrase}
            </motion.p>
          ))}
