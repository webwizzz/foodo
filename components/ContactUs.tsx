export default function ContactUs() {
  return (
    <section
      className="relative min-h-screen w-full text-white font-matter contact-bg-responsive"
    ...
    >
      <div className="mx-auto flex h-full min-h-screen w-full justify-center lg:justify-start text-center lg:text-left max-w-7xl items-start">
